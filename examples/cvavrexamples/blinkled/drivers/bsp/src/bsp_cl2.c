...
#ifdef COM_CFG_DEFINED
    // UART0_DR1 - 2022 (renamed to uart0dr1.h 30.1.22)
    #include "..\..\uart0\inc\uart0dr1.h"
    // UART1_DR1 - 2022 (renamed to uart1dr1.h 30.1.22)
    #include "..\..\uart1a\inc\uart1dr1.h"
#endif
...
#ifdef INIT_BLINK_OLED_CFG_DEFINED
